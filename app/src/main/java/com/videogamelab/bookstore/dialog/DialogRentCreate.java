...
public class DialogRentCreate extends DialogFragment {
    ...
    public static DialogRentCreate newInstance(Rent rent, Date availableDate, Integer maxRentDays) {
        DialogRentCreate dialog = new DialogRentCreate();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setView(v);
        builder.setTitle(R.string.dialog_title_new);
        builder.setPositiveButton(R.string.dialog_button_create, new CreateButtonListener());
    ...
    private class CreateButtonListener implements DialogInterface.OnClickListener {

        @Override
        public void onClick(DialogInterface dialog, int which) {
            Rent newRent = new Rent();
            newRent.setProperty(Rent.START_DATE, availableDate);
            ...
            cache.sendMessage(Utility.MESSAGE_DIALOG_RENT_CREATE, newRent);
        }
