...
public class DialogRentFinish extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setMessage(R.string.dialog_message_finish);

        builder.setPositiveButton(R.string.dialog_button_yes, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                cache.sendMessage(Utility.MESSAGE_DIALOG_RENT_FINISH, null);
            }
        });
